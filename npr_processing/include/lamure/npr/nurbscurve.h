...
namespace math {
  ...
  public : // methods
    ...
    point_t               evaluate        ( value_type const& t ) const;
    std::vector<value_type> evaluate_basis_function( value_type const& t ) const;
    size_t                get_knotspan(value_type const& t) const;
    size_t                get_multiplicity(value_type const& t) const;
